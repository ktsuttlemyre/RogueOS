...
run () {
  ...
  docker run --privileged  -it --name $container_name -v $HOME/rogueos_data/$host_name:/rogueos_data/ --shm-size=512m -p 6901:6901 -e KASM_USER=rogue -e VNC_PW=password $image_name
